...
// --- Unary minus (Precedence Level 2: Unary Operators) ---
...
// --- Binary Arithmetic Operations (Precedence Level 3: Arithmetic Operators) ---
// Note: The AST built by your parser already ensures that multiplication and division
// are evaluated before addition and subtraction according to BODMAS.
...
// --- Relational Operators (Precedence Level 4: Relational Operators) ---
...
// --- Logical Operators (Precedence Level 5: Logical Operators) ---
...
// --- Not Equals operator (Part of Relational Operators) ---
...
// --- Unary NOT operator (Precedence Level 2: Unary Operators) ---
...
// --- Assignments (Preserving existing functionality) ---
...
// --- LOOP_UNTIL (Existing functionality) ---
...
// --- STATEMENT_LIST (Existing functionality) ---
...
// --- Variable Declaration (VAR_DECL) (Existing functionality) ---
...
// --- TYPE operator (Existing functionality) ---
...
// --- Specific Declarations (DECL_INT, DECL_FLOAT, etc.) (Existing functionality) ---
...
// --- Conditional Constructs (Existing functionality) ---

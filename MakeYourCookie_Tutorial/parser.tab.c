...
static const char *const yytname[] =
{
  ...
  "PRINT", "PLUS", "ASSIGN", "SEMICOLON", "$accept", "program",
...
{
      12,    13,    13,    14,    15,     1,     2,    16,     7,     8,
       6,    10,    13,    11
};

static const yytype_int8 yycheck[] =
{
       6,     6,     6,     8,     8,     4,     5,    13,     3,     4,
       7,     0,     6,     4
};
...
#line 43 "parser.y"
                                           { (yyval.node) = createASTNode("ASSIGN", (yyvsp[-3].str), (yyvsp[-1].node), NULL); }
#line 1092 "parser.tab.c"
    break;

  case 6: /* statement: PRINT expression SEMICOLON  */
#line 44 "parser.y"
                                 { (yyval.node) = createASTNode("PRINT", NULL, (yyvsp[-1].node), NULL); }
...
#line 50 "parser.y"
                                 { (yyval.node) = createASTNode("PLUS", NULL, (yyvsp[-2].node), (yyvsp[0].node)); }
